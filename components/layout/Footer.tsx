        ...
        <div className="grid gap-12 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-6 leading-8 text-slate-400">
              Passionate QA Automation Engineer transitioning into
              DevOps. I enjoy building scalable automation frameworks,
              cloud-native applications and modern CI/CD pipelines.
            </p>
            ...
            <div className="mt-8 flex gap-4">
              ...
              <a
                ...
                className="rounded-full bg-slate-800 p-3 text-xl transition hover:bg-blue-600 hover:text-white"
              >
                <FaGithub />
              </a>
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              {technologies.map((tech) => (
                ...
                <div
                  key={tech.name}
                  title={tech.name}
                  className="flex h-14 w-14 items-center justify-center rounded-xl bg-slate-900 text-2xl text-blue-500 transition hover:bg-blue-600 hover:text-white"
                >
                  {tech.icon}
                </div>
